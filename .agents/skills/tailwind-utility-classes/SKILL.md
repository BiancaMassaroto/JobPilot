...
- **Background Color**: `bg-surface`, `bg-surface-secondary`, `bg-info`
...
<div class="group">
  ...
  <p class="text-text-secondary group-hover:text-accent">
    Hover the parent
  </p>
</div>
```
...
<!-- Custom colors -->
<div class="bg-[var(--color-info)] text-[var(--color-warning)]">
